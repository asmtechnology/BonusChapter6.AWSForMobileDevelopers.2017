...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GIDSignIn.sharedInstance().clientID = "insert your google client id"
    ...
    func application(_ application: UIApplication,
        ...
        //TO DO: Insert your facebook URL scheme here.
        //       The URL scheme can be generated by prefixing the
        //       characters fb to the Facebook app id.
        //
        //       For example: fb1234567890
        if url.scheme?.compare("insert facebook url scheme") == .orderedSame {
